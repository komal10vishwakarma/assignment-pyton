...
emp=[]
num_emp =  int(input("Enter the number of employe "))
for i  in range(num_emp):
     ...
     obj =  Employee(employee_id,employee_name,department,salary)
     emp.append(obj)

pro=[]
num_pro =  int(input("Enter the number of projects  "))
for i  in range(num_pro):
     print()
     pro_id    = int(input("Enter the project_id"))
     pro_name = input("Enter the  project_name")
     employee_id = input("Enter the  employee_id")
     pro_cost = int(input("Enter the   project_cost"))
     obj =  Project(pro_id,pro_name,employee_id,pro_cost)
     pro.append(obj)
...
""")
     ...
     match choice:
          case 1:
               Employee.display_all_employee(emp)
          case 2:
               Employee.search_emplooyee_by_id(emp)
          case 3:
               Employee.emp_by_dep(emp)
          case 4:
               Employee.max_sal_emp(emp)
          case 5:
               Employee.emp_project(emp,pro)
          case 6:
               Employee.max_cost_pro(pro)
          case 7:
               break