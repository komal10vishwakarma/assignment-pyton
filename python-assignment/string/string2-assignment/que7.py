...
s1=input("Enter citizen information::")
s2=input("Enter citizen information:")
s3=input("Enter citizen information:")
s4=input("Enter citizen information::")

print("Formatted Information:"+s1.title())
print("Formatted Information:"+s2.title())
print("Formatted Information:"+s3.title())
print("Formatted Information:"+s4.title())
